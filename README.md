...
#### 1. Используйте [**SOCKS5 Browser Configurator**](https://github.com/mirninec/socks5-browser-configurator) (рекомендую для Chromium-like браузеров)
...
#### 2. Запуск браузеров из консоли с аргументами командной строки.
